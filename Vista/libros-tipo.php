...
<div class="flex flex-1 justify-center items-center p-4">
    ...
    <div class="grid grid-cols-2 bg-white w-full h-full p-4 rounded-md gap-4 border border-gray-300 shadow-xl shadow-amber-100 ">
        ...
        <form class="border border-gray-500 rounded bg-gray-100 hover:bg-emerald-100 hover:border-emerald-500 group" method="POST">
            ...
            <input type="hidden" name="<?= md5('tipo') ?>" value="<?= md5('Bautizos') ?>">
        ...
        <form class="border border-gray-500 rounded bg-gray-100 hover:bg-emerald-100 hover:border-emerald-500 group" method="POST">
            <input type="hidden" name="<?= md5('action') ?>" value="<?= md5('DefinirTipolibro') ?>">
            <input type="hidden" name="<?= md5('tipo') ?>" value="<?= md5('Confirmaciones') ?>">
            <button type="submit" class="w-full cursor-pointer relative flex flex-col justify-between items-center p-2 rounded-md">
                ...
                <svg class="w-60" xmlns="http://www.w3.org/2000/svg" version="1.0" viewBox="0 0 512.000000 512.000000" preserveAspectRatio="xMidYMid meet">
                    <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none">
                        ...
                        <path d="M440 1646 c-116 -37 -165 -57 -164 -67 2 -23 75 -253 84 -262 8 -9 480 133 480 144 0 9 -221 239 -228 238 -4 0 -81 -24 -172 -53z" />
                        <path d="M4391 1584 c-61 -64 -111 -119 -111 -123 0 -11 473 -152 480 -144 14 15 89 268 82 274 -5 6 -235 80 -323 105 -11 3 -53 -34 -128 -112z" />
                        <path d="M541 840 c-265 -241 -484 -440 -485 -444 -2 -9 185 -216 195 -216 7 0 855 759 974 871 19 19 18 20 -85 124 -58 58 -107 105 -110 104 -3 0 -223 -198 -489 -439z" />
                        <path d="M3980 1175 c-91 -91 -103 -107 -90 -119 120 -113 973 -876 979 -876 6 0 80 79 183 196 18 20 12 25 -468 460 -268 241 -489 440 -493 442 -3 1 -53 -45 -111 -103z" />
                        <path d="M1377 623 c-43 -135 -74 -250 -70 -254 9 -8 274 -92 277 -87 1 2 28 86 60 188 l57 185 -45 40 c-24 22 -78 70 -119 108 -41 37 -76 67 -79 67 -2 0 -39 -111 -81 -247z" />
                        <path d="M3615 832 c-22 -20 -75 -69 -118 -108 l-78 -71 58 -184 c31 -101 58 -186 59 -187 3 -5 267 78 277 87 8 8 -142 501 -152 501 -3 0 -24 -17 -46 -38z" />
                    </g>
                </svg>
            </button>
        </form>
        ...
        <form class="border border-gray-500 rounded bg-gray-100 hover:bg-emerald-100 hover:border-emerald-500 group" method="POST">
            <input type="hidden" name="<?= md5('action') ?>" value="<?= md5('DefinirTipolibro') ?>">
            <input type="hidden" name="<?= md5('tipo') ?>" value="<?= md5('Defunciones') ?>">
            <button type="submit" class="w-full cursor-pointer relative flex flex-col justify-between items-center p-2 rounded-md">
        ...
        <form class="border border-gray-500 rounded bg-gray-100 hover:bg-emerald-100 hover:border-emerald-500 group" method="POST">
            <input type="hidden" name="<?= md5('action') ?>" value="<?= md5('DefinirTipolibro') ?>">
            <input type="hidden" name="<?= md5('tipo') ?>" value="<?= md5('Matrimonios') ?>">
            <button type="submit" class="w-full cursor-pointer relative flex flex-col justify-between items-center p-2 rounded-md">
