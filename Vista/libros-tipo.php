...
<div class="flex flex-1 justify-center items-center p-4">
    ...
    <div class="grid grid-cols-2 bg-white w-full h-full p-4 rounded-md gap-4 border border-gray-300 shadow-xl shadow-amber-100 ">
        ...
        <a href="<?= url('libros/seleccionar-tipo') ?>?tipo=1" class="border border-gray-500 rounded bg-gray-100 hover:bg-emerald-100 hover:border-emerald-500 group w-full cursor-pointer relative flex flex-col justify-between items-center p-2 rounded-md transition-all duration-200">
        ...
        <a href="<?= url('libros/seleccionar-tipo') ?>?tipo=2" class="border border-gray-500 rounded bg-gray-100 hover:bg-emerald-100 hover:border-emerald-500 group w-full cursor-pointer relative flex flex-col justify-between items-center p-2 rounded-md transition-all duration-200">
        ...
        <a href="<?= url('libros/seleccionar-tipo') ?>?tipo=3" class="border border-gray-500 rounded bg-gray-100 hover:bg-emerald-100 hover:border-emerald-500 group w-full cursor-pointer relative flex flex-col justify-between items-center p-2 rounded-md transition-all duration-200">
        ...
        <a href="<?= url('libros/seleccionar-tipo') ?>?tipo=4" class="border border-gray-500 rounded bg-gray-100 hover:bg-emerald-100 hover:border-emerald-500 group w-full cursor-pointer relative flex flex-col justify-between items-center p-2 rounded-md transition-all duration-200">
