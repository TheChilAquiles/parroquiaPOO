...
<div class="container mx-auto px-4 py-8">
    <!-- Encabezado -->
    <div class="mb-8">
        <h1 class="text-4xl md:text-5xl font-extrabold text-gray-900">Panel de Configuraci�n</h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <a href="<?= url('admin/configuraciones') ?>"
                   class="block p-6 bg-gradient-to-br from-[#F5F0EB] to-white rounded-lg border-2 border-[#DFD3C3] hover:border-[#D0B8A8] hover:shadow-lg transition duration-200">
                    ...
                    <p class="text-sm text-gray-600">Ajusta las configuraciones b�sicas del sistema</p>
                </a>
                ...
                <a href="<?= url('configuracion/pasarela-pagos') ?>"
                   class="block p-6 bg-gradient-to-br from-[#F5F0EB] to-white rounded-lg border-2 border-[#DFD3C3] hover:border-[#D0B8A8] hover:shadow-lg transition duration-200">
                    ...
                    <p class="text-sm text-gray-600">Configura la pasarela de pagos y m�todos de pago</p>
                </a>
                ...
                <a href="<?= url('feligreses') ?>"
                   class="block p-6 bg-gradient-to-br from-[#F5F0EB] to-white rounded-lg border-2 border-[#DFD3C3] hover:border-[#D0B8A8] hover:shadow-lg transition duration-200">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Gesti�n de Feligreses</h3>
                ...
                <a href="<?= url('reportes') ?>"
                   class="block p-6 bg-gradient-to-br from-[#F5F0EB] to-white rounded-lg border-2 border-[#DFD3C3] hover:border-[#D0B8A8] hover:shadow-lg transition duration-200">
                    ...
                    <p class="text-sm text-gray-600">Genera reportes y estad�sticas del sistema</p>
                </a>
    ...
    <div class="bg-white shadow-lg rounded-lg overflow-hidden">
        <div class="px-6 py-4 bg-gradient-to-r from-[#F5F0EB] to-[#E8DFD5] border-b border-[#DFD3C3]">
            <h2 class="text-xl font-semibold text-gray-800">Informaci�n del Sistema</h2>
        </div>

        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div class="flex justify-between py-2 border-b border-gray-200">
                    <span class="font-semibold text-gray-700">Versi�n del Sistema:</span>
                ...
                <div class="flex justify-between py-2 border-b border-gray-200">
                    <span class="font-semibold text-gray-700">�ltima Actualizaci�n:</span>
