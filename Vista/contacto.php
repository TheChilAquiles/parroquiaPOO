...
<main class="min-h-screen p-4 md:p-8 bg-slate-50 bg-grid-pattern">
    <section class="mb-6 md:mb-8 rounded-2xl bg-white p-6 md:p-8 shadow-sm border border-slate-200 card-hover">
        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
            <div class="flex items-start space-x-4 md:space-x-6">
                <div class="relative">
                    <div class="flex h-16 w-16 md:h-20 md:w-20 items-center justify-center rounded-2xl bg-blue-600 shadow-lg" style="background: linear-gradient(to bottom right, #1877f2, #0d5cb6);">
                        <span class="text-2xl md:text-3xl font-black text-white">f</span>
                    </div>
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="space-y-2">
                        <a id="fbLink" href="https://www.facebook.com/francisco.deasis.79274" target="_blank" class="inline-flex items-center text-sm text-slate-600 hover:text-[#1877f2] transition-colors duration-200 underline-offset-2 hover:underline break-all">
            ...
            <div class="flex flex-wrap gap-3">
                <button id="btnCopyLink" class="inline-flex items-center justify-center space-x-2 rounded-xl border border-slate-300 bg-white px-4 py-2.5 text-sm font-medium text-slate-700 shadow-sm transition-all duration-200 hover:bg-slate-50 hover:border-slate-400 hover:shadow-md flex-1 min-w-[140px]">
                ...
                <a id="btnContact" href="#contact-section" class="inline-flex items-center justify-center space-x-2 rounded-xl bg-[#1877f2] px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition-all duration-200 hover:bg-[#0d5cb6] hover:shadow-md flex-1 min-w-[140px]">
                    <svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div class="p-6 md:p-8 space-y-8">
            <div class="group flex flex-col lg:flex-row lg:items-start gap-6 rounded-xl p-6 transition-all duration-200 hover:bg-slate-50/80 border border-slate-200/50 card-hover">
                <div class="relative w-full lg:w-auto">
                    <img src="https://images.unsplash.com/photo-1545235617-9465d2a55698?q=80&w=256&auto=format&fit=crop" alt="Bosa San José" class="h-48 lg:h-20 lg:w-28 rounded-xl object-cover shadow-md w-full" />
                ...
                <div class="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
                    <a id="btnMapa" href="#" target="_blank" class="inline-flex items-center justify-center space-x-2 rounded-xl border border-slate-300 bg-white px-4 py-2.5 text-sm font-medium text-slate-700 shadow-sm transition-all duration-200 hover:bg-slate-50 hover:shadow-md">
                        <svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <button id="btnDetalles" class="inline-flex items-center justify-center space-x-2 rounded-xl bg-slate-900 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition-all duration-200 hover:bg-slate-800 hover:shadow-md">
            ...
            <div class="group flex flex-col lg:flex-row lg:items-start gap-6 rounded-xl p-6 transition-all duration-200 hover:bg-slate-50/80 border border-slate-200/50 card-hover">
                ...
                <div class="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
                    <button id="btnCopiarTelefono" class="inline-flex items-center justify-center space-x-2 rounded-xl border border-slate-300 bg-white px-4 py-2.5 text-sm font-medium text-slate-700 shadow-sm transition-all duration-200 hover:bg-slate-50 hover:shadow-md">
                        <svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <rect x="9" y="9" width="13" height="13" rx="2" ry="2" />
                            <path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" />
                        </svg>
                    ...
                    <a id="btnLlamar" href="tel:6014023526" class="inline-flex items-center justify-center space-x-2 rounded-xl bg-[#1877f2] px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition-all duration-200 hover:bg-[#0d5cb6] hover:shadow-md">
                        <svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.63A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
                        </svg>
...
<div id="modal" class="fixed inset-0 z-50 hidden items-center justify-center p-4">
    ...
    <div class="relative w-full max-w-md rounded-2xl bg-white shadow-2xl border border-slate-200">
        <div class="flex items-center justify-between border-b border-slate-200 p-6">
            ...
            <button id="closeModal" class="flex h-8 w-8 items-center justify-center rounded-lg border border-slate-300 bg-white text-slate-600 transition-colors hover:bg-slate-50">
                <svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div class="flex items-center justify-end space-x-3 border-t border-slate-200 p-6">
            <button id="closeModal2" class="inline-flex items-center rounded-xl border border-slate-300 bg-white px-4 py-2.5 text-sm font-medium text-slate-700 transition-colors hover:bg-slate-50">
                Cerrar
            </button>
            <a id="modalMaps" target="_blank" class="inline-flex items-center space-x-2 rounded-xl bg-slate-900 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-slate-800">
