...
<head>
    ...
    <style>
        /* Pequeño estilo para las transiciones de los modales y alertas */
        .modal, .modal-content { transition: all 0.3s ease-in-out; }
    </style>

    <script>
    window.appConfig = {
        // CORRECCIÓN: La carpeta es 'Vista' (singular), no 'Vistas'.
        ajaxUrl: '/Exercises PHP/parroquiaPOO/Vista/ajaxNoticias.php',
        csrfToken: '' 
    };
</script>
</head>
