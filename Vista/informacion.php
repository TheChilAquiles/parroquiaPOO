    ...
    <main class="mx-auto max-w-2xl rounded-xl bg-white p-6 shadow-md">
        <header class="mb-5 flex items-center justify-between border-b border-gray-200 pb-4">
            <div class="flex items-center">
                <img class="mr-4 h-12 w-12 rounded-lg object-cover" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT-As_mLQ9e2pUmMq1yfIbaHVeZ43CPnSnOOg&s" alt="Logo de la Parroquia San Francisco de Asís">
        ...
        <section class="mb-5 rounded-lg bg-gray-50 p-5">
            ...
            <p class="text-sm text-gray-600">Desde hace aproximadamente 27 años, fue construida una capilla en la vereda en ese entonces "San José - Bosa" atendida por los sacerdotes de las parroquias maría inmaculada y Santa María de Cana. Mediante el decreto N° 358, del 21 de marzo de 2015, el obispo de la diócesis de Soacha, Monseñor Daniel Caro Borda, creó la parroquia San Francisco de Asís. Contando con diferentes ...</p>
        </section>
        ...
        <section>
            ...
            <article class="group-item cursor-pointer mb-2 flex items-center justify-between rounded-lg p-4 transition duration-200 hover:bg-gray-100" onclick="openModal('legion-de-maria')">
                ...
                <span class="material-icons text-gray-500">keyboard_arrow_right</span>
            </article>
