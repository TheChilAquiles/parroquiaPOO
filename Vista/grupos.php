                    ...
                    <div class="p-6">
                        ...
                        <div class="flex gap-2">
                            <form method="POST" action="index.php" class="flex-1">
                                ...
                                <button type="submit" class="w-full px-4 py-2 bg-purple-600 text-white rounded-lg shadow-sm hover:bg-purple-700 transition duration-200 font-medium">
                                    Ver Detalles
                                </button>
                            </form>
                            ...
                            <div class="flex gap-1">
                                <form method="POST" action="index.php" style="display: inline;">
                                    ...
                                    <input type="hidden" name="grupo_id" value="<?php echo htmlspecialchars($grupo['id']); ?>">
                                    <button type="submit" class="px-3 py-2 bg-blue-100 text-blue-600 rounded-lg hover:bg-blue-200 transition duration-200" title="Editar grupo">
    ...
    <div class="relative top-20 mx-auto p-5 border w-full max-w-md shadow-lg rounded-md bg-white">
        <div class="mt-3">
            ...
            <form action="index.php" method="POST">
                ...
                <div class="mb-4">
                    <label for="nombre_grupo" class="block text-gray-700 font-medium mb-2">Nombre del Grupo *</label>
                    <input type="text"
                        id="nombre_grupo"
                        name="nombre_grupo"
                        required
                ...
                <div class="flex gap-3">
                    <button type="submit" class="flex-1 px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition duration-200 font-medium">
                        Crear Grupo
                    </button>
                    <button type="button" id="btnCerrarModal" class="flex-1 px-4 py-2 bg-gray-300 text-gray-800 rounded-lg hover:bg-gray-400 transition duration-200 font-medium">
                        Cancelar
                    </button>
                </div>
            </form>
